...
public class TabNews extends Tab {
	...
	String nflink = "http://m.simplepie.org/?feed=http%3A%2F%2Fapocalypsead.enjin.com%2Fhome%2Fm%2F23148107%2Frss%2Ftrue";
	String testlink = "http://textuploader.com/03aa/raw";
	public TabNews(GUI owner) {
		super(0, 0, 0, 0, owner);
		addComponent(new ComponentContainerWebsite(20, 80, getWidth() - 20 - 20, getHeight() - 80 - 20, owner, nflink));
	}
